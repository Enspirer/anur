        ...
        <div class="row">
            ...
            <div class="col-12 col-md second-column">
                ...
                <div class="row align-items-center mb-3 ms-2 ms-md-0">
                    ...
                    <div class="col-10 pl-0">
                        <p class="text-white">info@eshop.com</p>
                    </div>
                </div>
                ...
                <div class="row align-items-center mb-3 ms-2 ms-md-0">
                    ...
                    <div class="col-10 pl-0">
                        <p class="text-white">587/ C NUGEGODA, COLOMBO 5</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-md links quick" style="padding-left: 3rem;">
                ...
                <a href="" class="mb-3 text-decoration-none text-white ms-4 ms-md-0">Explore</a> <br>
                <a href="" class="mb-3 text-decoration-none text-white ms-4 ms-md-0">Training</a> <br>
                <a href="" class="mb-3 text-decoration-none text-white ms-4 ms-md-0">About Us</a>
            </div>
